...
void __init dmi_check_pciprobe(void)
{
	int count;
	printk("===========================================================================\n");
	printk(" START - CHECK SYSTEM DMI using dmi_check_pciprobe()\n");
	printk("===========================================================================\n");
	count = dmi_check_system(pciprobe_dmi_table);
	printk("dmi_check_system number of matches: %d\n", count);
	printk("===========================================================================\n");
	printk(" END - CHECK SYSTEM DMI using dmi_check_pciprobe()\n");
	printk("===========================================================================\n");
}
